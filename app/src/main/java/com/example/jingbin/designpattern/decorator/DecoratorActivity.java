...
public class DecoratorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.bt_demo1:
                Log.e(TagContants.TAG, "一个镶嵌2颗红宝石,1颗蓝宝石的靴子: ");

                IEquip iEquip = new RedGemDecotator(new RedGemDecotator(new BlueGemDecotator(new ShoeEquip())));
                Log.e(TagContants.TAG, "攻击力:" + iEquip.caculateAttack());
                Log.e(TagContants.TAG, "描述语:" + iEquip.description());
                break;

            case R.id.bt_demo2:
                Log.e(TagContants.TAG, "一个镶嵌1颗红宝石,1颗蓝宝石,1颗黄宝石的戒指: ");
                RedGemDecotator redGemDecotator = new RedGemDecotator(new BlueGemDecotator(new YellowGemDecotator(new RingEquip())));
                Log.e(TagContants.TAG, "攻击力:" + redGemDecotator.caculateAttack());
                Log.e(TagContants.TAG, "描述语:" + redGemDecotator.description());
                break;
            default:
                break;
        }
